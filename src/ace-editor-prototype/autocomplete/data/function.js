...
export default [
  { name: 'Aggregate', isAggregate: true, functions: AGGREGATE_FUNCTIONS },
  { name: 'Analytic', isAnalytic: true, functions: ANALYTIC_FUNCTIONS },
  { name: 'Collection', functions: COLLECTION_FUNCTIONS },
  { name: 'Complex Type', functions: COMPLEX_TYPE_CONSTRUCTS },
  { name: 'Conditional', functions: CONDITIONAL_FUNCTIONS },
  { name: 'Date', functions: DATE_FUNCTIONS },
  { name: 'Mathematical', functions: MATHEMATICAL_FUNCTIONS },
  { name: 'Misc', functions: MISC_FUNCTIONS },
  { name: 'String', functions: STRING_FUNCTIONS },
  { name: 'Data Masking', functions: DATA_MASKING_FUNCTIONS },
  { name: 'Table Generating', functions: TABLE_GENERATING_FUNCTIONS },
