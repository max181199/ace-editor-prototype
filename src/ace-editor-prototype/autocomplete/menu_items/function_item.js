...
const FunctionItem = React.forwardRef(({suggest , isChosen , index},ref) => {
      ...
      >
        ...
        >
          <Grid item zeroMinWidth >
            <Name noWrap>
              <FunctionName>{suggest.meta.name}</FunctionName>
              <FunctionBrackets>{' (...)'}</FunctionBrackets>
            </Name>
          </Grid>
          <Grid item zeroMinWidth>
