...
import './text/text-hive-highlight-rules'

ace.define(
  "ace/mode/hive_highlight_rules",
  ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_hive_highlight_rules"],
  ...
  oop.inherits(HiveHighlightRules, TextHiveHighlightRules);
